...
public class AdminTests extends BaseTest {
    ...
    protected String getReportName() {
        return "extent-report-admin.html";
    }
    ...
    public void testAdminLogin_InvalidEmail() {
        ...
        try {
            ...
            WebElement errorMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[contains(text(), 'Invalid email address') or contains(text(), 'Email is not valid')]")));
